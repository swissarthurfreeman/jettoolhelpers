...
BENCHMARK_DEFINE_F(JetFixture, BM_getJetValueOver2DHistogram)(benchmark::State& state) {
    ...
    HistoInput2D histogram = HistoInput2D("Test histogram", fileName, histName2D, "pt", "float", true, "abseta", "float", true);
...
BENCHMARK_DEFINE_F(JetFixture, BM_getJetValueOver1DHistogram)(benchmark::State& state) {
    ...
    HistoInput1D histogram = HistoInput1D("Test histogram", fileName, histName1D, "pt", "float", true);
    histogram.initialize();
...
BENCHMARK_DEFINE_F(JetContextFixture, BM_getJetContextValueOver1DHistogram)(benchmark::State& state) {
    ...
    HistoInput1D histogram = HistoInput1D("Test histogram", fileName, histName1D, "saspidity", "float", false);
    histogram.initialize();
